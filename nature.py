...
# Configure page
st.set_page_config(page_title="Nature Sound Generator", page_icon="🌿")
...
# Streamlit UI
st.title("🌳 Nature Soundscape Generator")
...
selected_sound = st.selectbox(
    ...
    format_func=lambda x: f"{x} {'🌧️' if 'Rain' in x else '🌊' if 'Ocean' in x else '🌲'}"
)
